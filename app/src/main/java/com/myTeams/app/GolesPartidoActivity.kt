...
class GolesPartidoActivity : AppCompatActivity() {

    private lateinit var binding: ActivityGolesPartidoBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityGolesPartidoBinding.inflate(layoutInflater)
